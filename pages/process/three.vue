...
onMounted(() => {
  ...
  } else if (route.path === '/process/three/file') {
    isActiveTab.value = 1
  } else if (route.path === '/process/three/form') {
    isActiveTab.value = 2
  } else if (route.path === '/process/three/render') {
    isActiveTab.value = 3
  }
})
</script>
